...
@Composable
fun MyMessageDetailScreen(
    modifier: Modifier = Modifier,
    myWritingTemplateData: MyWritingTemplateData,
    onMovePageMessageEdit: (MyWritingTemplateData) -> Unit = {},
    ...
    Column(
        ...
        Column(
            ...
            PretendardText(
                text = "Date: ${myWritingTemplateData.formatDate}",
                fontSize = 14.sp,
                modifier = Modifier
                    .align(Alignment.End)
                    .padding(top = 16.dp)
            ...
            Row(
                ...
                NuguFillButton(
                    ...
                    text = "삭제하기",
                    onClick = {
                        showDeleteTemplateConfirmDialog = Pair(myWritingTemplateData.id, true)
                    }
                )
                ...
                NuguFillButton(
                    modifier = Modifier.weight(1f),
                    text = "템플릿 보러가기",
                    onClick = { onMovePageMessageEdit.invoke(myWritingTemplateData) }
                )
            }
        }
    }
